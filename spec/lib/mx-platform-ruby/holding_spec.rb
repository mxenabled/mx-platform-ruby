...
RSpec.describe ::MxPlatformRuby::Holding do
  ...
  let(:holding_response) { { 'holding' => holding_attributes } }
  ...
  describe 'read_holding' do
    before { allow(::MxPlatformRuby.client).to receive(:make_request).and_return(holding_response) }
