...
# Unit tests for MxPlatformRuby::Category
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MxPlatformRuby::Category do
  let(:instance) { MxPlatformRuby::Category.new }

  describe 'test an instance of Category' do
    it 'should create an instance of Category' do
      expect(instance).to be_instance_of(MxPlatformRuby::Category)
    end
  end
