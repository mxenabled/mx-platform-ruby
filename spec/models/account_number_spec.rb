...
# Unit tests for MxPlatformRuby::AccountNumber
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MxPlatformRuby::AccountNumber do
  let(:instance) { MxPlatformRuby::AccountNumber.new }

  describe 'test an instance of AccountNumber' do
    it 'should create an instance of AccountNumber' do
      expect(instance).to be_instance_of(MxPlatformRuby::AccountNumber)
    end
  end
