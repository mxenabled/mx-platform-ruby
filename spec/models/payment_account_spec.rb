...
# Unit tests for MxPlatformRuby::PaymentAccount
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MxPlatformRuby::PaymentAccount do
  let(:instance) { MxPlatformRuby::PaymentAccount.new }

  describe 'test an instance of PaymentAccount' do
    it 'should create an instance of PaymentAccount' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MxPlatformRuby::PaymentAccount)
    end
  end
