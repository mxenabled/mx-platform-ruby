...
# Unit tests for MxPlatformRuby::ProcessorAccountNumberBodyAccountNumbersInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MxPlatformRuby::ProcessorAccountNumberBodyAccountNumbersInner do
  let(:instance) { MxPlatformRuby::ProcessorAccountNumberBodyAccountNumbersInner.new }

  describe 'test an instance of ProcessorAccountNumberBodyAccountNumbersInner' do
    it 'should create an instance of ProcessorAccountNumberBodyAccountNumbersInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MxPlatformRuby::ProcessorAccountNumberBodyAccountNumbersInner)
    end
  end
