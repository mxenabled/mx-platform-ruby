...
# Unit tests for MxPlatformRuby::Challenge
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MxPlatformRuby::Challenge do
  let(:instance) { MxPlatformRuby::Challenge.new }

  describe 'test an instance of Challenge' do
    it 'should create an instance of Challenge' do
      expect(instance).to be_instance_of(MxPlatformRuby::Challenge)
    end
  end
