...
# Unit tests for MxPlatformRuby::AccountOwner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MxPlatformRuby::AccountOwner do
  let(:instance) { MxPlatformRuby::AccountOwner.new }

  describe 'test an instance of AccountOwner' do
    it 'should create an instance of AccountOwner' do
      expect(instance).to be_instance_of(MxPlatformRuby::AccountOwner)
    end
  end
