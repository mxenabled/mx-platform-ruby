...
# Unit tests for MxPlatformRuby::ProcessorAccountNumber
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MxPlatformRuby::ProcessorAccountNumber do
  let(:instance) { MxPlatformRuby::ProcessorAccountNumber.new }

  describe 'test an instance of ProcessorAccountNumber' do
    it 'should create an instance of ProcessorAccountNumber' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MxPlatformRuby::ProcessorAccountNumber)
    end
  end
