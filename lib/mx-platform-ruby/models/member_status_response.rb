...
module MxPlatformRuby
  class MemberStatusResponse
    ...
    def hash
      [aggregated_at, challenges, connection_status, guid, has_processed_account_numbers, has_processed_accounts, has_processed_transactions, is_authenticated, is_being_aggregated, successfully_aggregated_at].hash
    end
