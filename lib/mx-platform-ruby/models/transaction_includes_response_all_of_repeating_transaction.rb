...
module MxPlatformRuby
  class TransactionIncludesResponseAllOfRepeatingTransaction
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `MxPlatformRuby::TransactionIncludesResponseAllOfRepeatingTransaction` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `MxPlatformRuby::TransactionIncludesResponseAllOfRepeatingTransaction`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def valid?
      ...
      recurrence_type_validator = EnumAttributeValidator.new('String', ["EVERY_OTHER_WEEK"])
    ...
    def recurrence_type=(recurrence_type)
      validator = EnumAttributeValidator.new('String', ["EVERY_OTHER_WEEK"])
    ...
    def hash
      [repeating_transaction_type, recurrence_type, guid].hash
    end
