...
module MxPlatformRuby
  class AccountNumberResponse
    ...
    def hash
      [account_guid, account_number, guid, institution_number, loan_guarantor, loan_reference_number, member_guid, passed_validation, routing_number, sequence_number, transit_number, user_guid].hash
    end
