...
module MxPlatformRuby
  class ConnectWidgetRequest
    ...
    def hash
      [client_redirect_url, color_scheme, current_institution_code, current_member_guid, disable_background_agg, disable_institution_search, enable_app2app, include_identity, include_transactions, is_mobile_webview, mode, oauth_referral_source, ui_message_version, ui_message_webview_url_scheme, update_credentials].hash
    end
